...
humandate: "April 24-27, 2023"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Trisha Adamus", "Sarah Stevens"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
eventbrite:   549562294617        # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
locations:            # for online events, delete the second section below. for in-person events, customize the second section and delete the first section.
  - venue: "UW-Madison" 
    address: "11th floor, 447 Lorch St., Madison, WI"
    latlng: "43.074870,-89.409530"
